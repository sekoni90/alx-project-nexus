      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Mon-Fri: 9:00 AM - 6:00 PM CET</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Ajocks Store GmbH<br />
                      Outdoor No 2, Adeyeye Street<br />
                      Mile 12 Kosofe 100241 Lagos, Nigeria
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-lg p-8">
              ...
              <p className="text-gray-700 mb-4">Looking for quick answers? Check out these resources:</p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-center text-gray-700 mb-6">
            Located in the heart of Lagos, our flagship store welcomes outdoor enthusiasts from around the world.
            Come visit us to see our full range of products and get expert advice from our knowledgeable staff.
          </p>
          <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
            <p className="text-gray-600">Map placeholder - Outdoor No 2, Adeyeye Street  Mile 12 Kosofe 100241 Lagos, Nigeria</p>
          </div>
        </div>
      </div>
    </div>
